...
public class TelaBuscaAreaCompartilhada extends javax.swing.JDialog {

    public TelaBuscaAreaCompartilhada(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        jComboFiltrar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Descrição", "Status" }));
        jComboOrdenar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Descrição", "Status" }));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Busca de Áreas Compartilhadas");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaAreaCompartilhada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBuscaAreaCompartilhada dialog = new TelaBuscaAreaCompartilhada(new javax.swing.JFrame(), true);
