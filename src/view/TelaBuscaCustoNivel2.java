...
public class TelaBuscaCustoNivel2 extends javax.swing.JDialog {

    public TelaBuscaCustoNivel2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        jComboFiltrar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Descrição", "Tipo CC", "Custo Nível 1", "Status" }));
        jComboOrdenar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Descrição", "Tipo CC", "Custo Nível 1", "Status" }));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Busca de Custos Nível 2");
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Descrição", "Tipo CC", "Custo Nível 1", "Status"
            }
        ));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaCustoNivel2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBuscaCustoNivel2 dialog = new TelaBuscaCustoNivel2(new javax.swing.JFrame(), true);
