...
public class TelaBuscaUnidade extends javax.swing.JDialog {

    public TelaBuscaUnidade(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        jComboFiltrar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Descrição", "Edifício" }));
        jComboOrdenar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Descrição", "Edifício" }));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Busca de Unidades");
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Descrição", "Metragem Total", "Tipo", "Edifício"
            }
        ));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaUnidade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBuscaUnidade dialog = new TelaBuscaUnidade(new javax.swing.JFrame(), true);
