...
public class TelaBuscaFornecedor extends javax.swing.JDialog {
    ...
    public TelaBuscaFornecedor(java.awt.Frame parent, boolean modal) {
        ...
        jComboFiltrar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Nome Fantasia", "Razão Social", "CNPJ", "Cidade" }));
        jComboOrdenar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Nome Fantasia", "Razão Social", "CNPJ", "Cidade" }));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Busca de Fornecedores");
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome Fantasia", "Razão Social", "CNPJ", "Cidade"
            }
        ));
