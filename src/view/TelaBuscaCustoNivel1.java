...
public class TelaBuscaCustoNivel1 extends javax.swing.JDialog {
    ...
    public TelaBuscaCustoNivel1(java.awt.Frame parent, boolean modal) {
        ...
        jComboFiltrar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Descrição", "Tipo CC", "Status" }));
        jComboOrdenar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Descrição", "Tipo CC", "Status" }));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Busca de Custos Nível 1");
