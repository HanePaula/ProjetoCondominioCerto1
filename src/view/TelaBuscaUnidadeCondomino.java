...
public class TelaBuscaUnidadeCondomino extends javax.swing.JDialog {

    public TelaBuscaUnidadeCondomino(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        jComboFiltrar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Unidade", "Proprietário", "Status" }));
        jComboOrdenar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Unidade", "Proprietário", "Status" }));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Busca de Unidades Condôminos");
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Unidade", "Proprietário", "Data Aquisição", "Status"
            }
        ));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaUnidadeCondomino.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBuscaUnidadeCondomino dialog = new TelaBuscaUnidadeCondomino(new javax.swing.JFrame(), true);
