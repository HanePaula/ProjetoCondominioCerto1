...
public class TelaBuscaSindicoProfissional extends javax.swing.JDialog {

    public TelaBuscaSindicoProfissional(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        jComboFiltrar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Nome Fantasia", "Razão Social", "CRA" }));
        jComboOrdenar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Id", "Nome Fantasia", "Razão Social", "CRA" }));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Busca de Síndicos Profissionais");
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome Fantasia", "Razão Social", "CPF/CNPJ", "CRA"
            }
        ));
        ...
        jLabelOrdenar.setText("Filtrar por:");
        ...
        jPanelFiltrarLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelFiltrarLayout.createSequentialGroup()
                ...
                .addGroup(jPanelFiltrarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jComboFiltrar, 0, 247, Short.MAX_VALUE)
                ...
                .addGroup(jPanelFiltrarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelFiltrarLayout.createSequentialGroup()
                        .addGroup(jPanelFiltrarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jFTValor, javax.swing.GroupLayout.DEFAULT_SIZE, 209, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaSindicoProfissional.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBuscaSindicoProfissional dialog = new TelaBuscaSindicoProfissional(new javax.swing.JFrame(), true);
